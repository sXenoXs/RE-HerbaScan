...
void main() {
  group('Simple GradCAM Tests', () {
    test('should create test image successfully', () async {
      ...
      print('✅ Test image created successfully (${testImageData.length} bytes)');
    });
    ...
    test('should create realistic plant image', () async {
      ...
      print('✅ Plant image created successfully (${plantImageData.length} bytes)');
    });
    ...
    test('should create realistic predictions', () async {
      ...
      print('✅ Realistic predictions created (top: ${(maxPrediction * 100).toStringAsFixed(1)}%)');
    });
  });
}
